  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-bold mb-4 text-indigo-200">Demo temporarily disabled</h2>
        <p className="text-indigo-300/80 mb-6">
          This demo route previously depended on a todos schema that is no longer present.
          Re-enable it after restoring the corresponding database model and queries.
        </p>
