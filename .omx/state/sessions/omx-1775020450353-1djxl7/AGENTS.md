...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775020450353-1djxl7 | 2026-04-01T05:14:10.407Z

**Codebase Map:**
  src/: env, routeTree.gen, router
  src/components/: Footer, Header, ThemeToggle
  src/data/: demo-table-data
  src/db/: schema
  src/integrations/: header-user, devtools, root-provider
  src/lib/: auth-client, auth
  src/orpc/: client, todos, schema
  src/routes/: __root, about, api.$, api.rpc.$, $, better-auth, drizzle, orpc-todo, sentry.testing, table
  (root): drizzle.config, vite.config
